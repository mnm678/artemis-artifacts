...
def generate_keys():
  ...
  generate_and_write_rsa_keypair("password", "keystore/root_key")
  generate_and_write_rsa_keypair("password", "keystore/root_key2")
  generate_and_write_ed25519_keypair("password", 'keystore/targets_key')
  generate_and_write_ed25519_keypair("password", 'keystore/snapshot_key')
  generate_and_write_ed25519_keypair("password", 'keystore/timestamp_key')

  # Also create additional role keys for delegations
  generate_and_write_ed25519_keypair("password", 'keystore/wabbit_networks_key')
  generate_and_write_ed25519_keypair("password", 'keystore/my_repo_key')


def create_registry(directory_name):
  ...
  registry = create_new_repository(directory_name)
  ...
  registry.writeall(snapshot_merkle=False)
...
def large_snapshot_demo():
  ...
  for i in range(16):
    ...
    sslib_util.ensure_parent_dir(filepath)
...
if __name__ == '__main__':
  ...
  #create_registry("test_repository1")
  # large_snapshot_demo()
